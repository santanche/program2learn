...
* Latest stable/tested version [![launch @ mybinder.org][badge-jupyterlab-mybinder-org]](https://mybinder.org/v2/gh/santanche/program2learn/1.5)

## Install a Local Guile over Jupyter

* [setup.md](scheme/tools/guile/setup.md): to set the Guile over Jupyter for the first time;
* [run.md](scheme/tools/guile/run.md): to run the server as the setup is configured.
